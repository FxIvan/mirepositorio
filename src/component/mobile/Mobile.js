...
export const Mobile = () =>{
    ...
    return(
      ...
      <section className="container">
        <div className="row m-auto d-flex align-items-center section-1 mt-3 pt-3">
          ...
          <div className="col-8">
            ...
            <Typed 
            strings={["Hola mi nombre es Ivan, tengo 21 años y soy de la provincia de Buenos Aires Argentina, me dedico al desarrollo Frontend."]}
            typeSpeed={20}
            />
          </div>
        </div>
            ...
            <div className='container'>
              <div className='mt-3'>
                ...
                <div className='mas-proyecto-en text-center mt-4'>
                  ...
                  <a href='https://github.com/FxIvan'>github.com/FxIvan</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className='text-center footer-container pb-2'>
        <div>
